...
import {BookOpen,Info,Edit2,Trash2, UserCircle} from "lucide-react";
...
const BookCard =({book,setBooks}) => {
    ...
    return(
       <>
        {/* CARD */}
        <Link to={`/book/${book._id}`} className={`relative block rounded-xl
         bg-base-100 p-4 border transition-all
        duration-200${isActive ? "border-primmary shadow-lg" :"border-base-300"}
        ...
        {/*Footer*/}
         <div className="mt-6 flex justify-between items-center">
            ...
            {formatData(new Date(book.createdAt))}
                ...
                <Edit2 className="text-xs text-base-content/60 truncate" />
            </div>
                ...
                <div className="modal-box">
                    <h3 className="font-bold text-error flex items-center gap-2">
                        ...
                        <span className="font-semibold text-base-content">
                            {" "}"{book.title}" </span>? <br /> This action must cannot be undone.</p>
